...
class StainNormalizationDataset(Dataset):
    """Dataset for stain normalization."""
...
def get_dataloader(root, split, config):
    ...
    dataset = StainNormalizationDataset(root, split, transform)
    return DataLoader(
        dataset,
